    ...
    function (t, e, n) {
        ...
        (i.resize = E(u, _)),
            ...
            (i.destroy = function (t) {
                (t = t || {}), (p = !0), u.triggerHandler("__wf_destroy"), null != t.domready && (h = t.domready), f.each(r, m), i.resize.off(), i.scroll.off(), i.redraw.off(), (o = []), (a = []), "pending" === k.state() && S();
            }),
            s(i.ready),
            S(),
        ...
        window.tram = (function (t) {
            ...
            var l = (function (t, e, n) {
                ...
                A = function (t) {
                    ...
                    for (e = 0; e < z.length; e++) if ((n = z[e] + i) in T.style) return { dom: n, css: j[e] + t };
                },
                M = (e.support = { bind: Function.prototype.bind, transform: A("transform"), transition: A("transition"), backface: A("backface-visibility"), timing: A("transition-timing-function") });
            if (M.transition) {
                var C = M.timing.dom;
                if (((T.style[C] = f["ease-in-back"][0]), !T.style[C])) for (var $ in d) f[$][0] = d[$];
            }
            var q = (e.frame = (function () {
                ...
                F = l(function (e) {
                        ...
                        if (t) {
                            ...
                            if ("object" == o) {
                                ...
                                h.call(
                                    ...
                                    d.call(this),
                                    c > 0 && ((this.timer = new H({ duration: c, context: this })), (this.active = !0), e && (this.timer.complete = a));
                                var p = this,
                                    v = !1,
                                    m = {};
                                q(function () {
                    ...
                    (e.init = function (e) {
                        ...
                        b("start", o),
                        b("wait", function (t) {
                            (t = u(t, 0)), this.active ? this.queue.push({ options: t }) : ((this.timer = new H({ duration: t, context: this, complete: a })), (this.active = !0));
                        }),
                        b("then", function (t) {
                    ...
                    (t.init = function (t, e, n, i) {
                        ...
                        n[2] && (o = n[2]),
                            ...
                            W.fallback || i.fallback
                                ...
                                : ((this.animate = this.transition), (this.string = this.name + S + this.duration + "ms" + ("ease" != this.ease ? S + f[this.ease][0] : "") + (this.delay ? S + this.delay + "ms" : "")));
                    }),
                        (t.set = function (t) {
                ...
                R = l(P, function (t, e) {
                    ...
                    (t.init = function () {
                        e.init.apply(this, arguments), this.current || ((this.current = {}), Y.perspective && W.perspective && ((this.current.perspective = W.perspective), X(this.el, this.name, this.style(this.current)), this.redraw()));
                    }),
                        (t.set = function (t) {
                ...
                U = l(function (e) {
                    function n() {
                        var t,
                            ...
                            i,
                            r = u.length;
                        if (r) for (q(n), e = D(), t = r; t--; ) (i = u[t]) && i.render(e);
                    }
            ...
            var X = t.style,
                ...
                Y = {};
            M.transform && ((Q.transform = [R]), (Y = { x: [x, "translateX"], y: [x, "translateY"], rotate: [k], rotateX: [k], rotateY: [k], scale: [g], scaleX: [g], scaleY: [g], skew: [k], skewX: [k], skewY: [k] })),
                M.transform && M.backface && ((Y.z = [x, "translateZ"]), (Y.rotateZ = [k]), (Y.scaleZ = [g]), (Y.perspective = [y]));
            var J = /ms/,
                V = /s|\./;
            return (t.tram = e);
        })(window.jQuery);
                        ...
                        function () {
                            (r = !0),
                                ...
                                (function (t) {
                                    ...
                                    t.ajax({ url: m("https://editor-api.webflow.com/api/editor/view"), data: { siteId: a.attr("data-wf-site") }, xhrFields: { withCredentials: !0 }, dataType: "json", crossDomain: !0, success: d(e) });
                                });
                        },
                    l = !1;
                try {
                                        ...
                                        !(function (e, n) {
                                            ...
                                            !(function t() {
                                                ...
                                                r.scroll(
                                                    ...
                                                    (function (t, e, n, i) {
                                                        if (n > i) return e;
                                                        return t + (e - t) * ((r = n / i), r < 0.5 ? 4 * r * r * r : (r - 1) * (2 * r - 2) * (2 * r - 2) + 1);
                                                        var r;
                                                    })(i, o, e, f)
                                                ),
                                                    e <= f && l(t);
        ...
        i.define(
            ...
            (t.exports = function (t, e) {
                ...
                (u.ready = u.design = u.preview = function () {
                    ...
                    o.each(E), k(), i.resize.on(_);
                }),
                    (u.destroy = function () {
                        (x = t()), k(), o && o.length && o.each(O);
                    });
                ...
                function q(t, e) {
                    if (!t.open) {
                        ...
                        var r = D(t),
                            ...
                            u = t.el.height(),
                            l = t.el[0];
                        if ((A(0, l), y.intro(0, l), i.redraw.up(), a || f.on("click" + p, t.outside), !e)) {
                            var d = "transform " + n.duration + "ms " + n.easing;
                            if ((t.overlay && ((x = t.menu.prev()), t.overlay.show().append(t.menu)), n.animOver))
                                return (
                                    c(t.menu)
                                        .add(d)
                ...
                function F(t, e) {
                    ...
                    function u() {
                        t.menu.height(""),
                            ...
                            t.overlay && t.overlay.children().length && (x.length ? t.menu.insertAfter(x) : t.menu.prependTo(t.parent), t.overlay.attr("style", "").hide()),
